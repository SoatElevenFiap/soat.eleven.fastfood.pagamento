...
class MercadoPagoPaymentStatus(str, Enum):
    ...
    REJECTED = "rejected" # O pagamento foi rejeitado (o usuário pode tentar pagar novamente).
    ...
    CHARGED_BACK = "charged_back" # Um chargeback foi aplicado no cartão de crédito do comprador.

...
from modules.shared.decorators.api.utils.file_manager import FileManager
...
class API:
    ...
    def initialize(app: FastAPI, prefix: str = None):
        for controller in API.__get_controllers():
    ...
    def route(
        ...
        normalized_path = API.__normalize_api_path(path)

...
def get_client_by_notification_url_service_provider(client_repository: ClientRepositoryProvider):
...
GetClientByNotificationUrlServiceProvider = Annotated[
    GetClientByNotificationUrlService, Depends(get_client_by_notification_url_service_provider)
]

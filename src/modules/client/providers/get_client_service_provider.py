...
def get_client_service_provider(
    redis_service: RedisServiceProvider, client_repository: ClientRepositoryProvider
):
    return GetClientService(cache=redis_service, client_repository=client_repository)
